...
describe("validate/validate-address", function () {
  ...
  uppercaseAddresses.forEach(function (address) {
    test({
  ...
  lowercaseAddresses.forEach(function (address) {
    test({
  ...
  normalAddresses.forEach(function (address) {
    test({
  ...
  wrongCapitalizationAddresses.forEach(function (address) {
    testInvalidChecksum({
